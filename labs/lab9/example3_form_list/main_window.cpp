...
MainWindow::MainWindow()
{
	...
	connect(quoteListWidget, SIGNAL(currentRowChanged(int)), this, SLOT(displayQuote(int))); //pointer to object which is going to emit signal, actual signal we are listening for, what receives the signal, what function we want to gets called
